...
![lernOS Circle von @simondueckert, CC BY 4.0](images/lernOS-Circle.png)
...
![lernOS Canvas (lernOS.org) von @simondueckert, CC BY 4.0](../../lernOS%20Canvas/de/lernOS-Canvas-de.png)
...
**Hinweis:** die ursprüngliche Idee für dieses großartige Auswahl an Übungen kam von [John Stepper](https://twitter.com/johnstepper), wie in den [WOL Guides](https://workingoutloud.com/en/circle-guides) beschrieben. Da die WOL Guides unter der Creative Commons Attribution NonCommercial NoDerivatives Lizenz (CC BY NC ND) veröffentlicht sind, konnte der Inhalt für diesen Leitfaden nicht wiederverwendet werden, sondern musste neu geschrieben werden.
...
![Warum bist du hier?](images/lernOS-Kata-01.png)
